...
int main() {
    ...
    b1.author = "J.D. Salinger";
    Book b2; 
    b2.title = "Hitchikers Guide to the Galaxy";
    ...
    b1.title = "Allison Wonderland";
    l1.PrintBooks();
    // Answer (and your hypothesis for why/why not):
    //It did not change, and it probably is because I should've used a pointer 
    ...
    // Answer: It did not even compile, as it said I couldn't compare two Book data types
    ...
    // Answer: This time it did not compile
    */
    ...
    // Answer: This time it compiled, but said that they are not equal
